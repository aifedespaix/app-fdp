...
@Component({
  selector: 'app-fdp-lou-p7',
  templateUrl: './fdp-lou-p7.component.html',
  styleUrls: ['./fdp-lou-p7.component.scss']
})
export class FdpLouP7Component implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.music = new Audio('/assets/images/loup/jeux/7/a.mp3');
  ...
  public verifyAnswer() {
    if (this.answer.value.toUpperCase() === 'BASSHUNTER') {
      this.music.pause();
      this.win.play();
      setTimeout(() => {
        this.router.navigateByUrl('LouPD/ggvezrsd');
      }, 2000);
    } else {
      this.loose.play();
